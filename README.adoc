...
image::https://www.codefactor.io/repository/github/whelk-io/asciidoc-template-maven-plugin/badge[https://www.codefactor.io/repository/github/whelk-io/asciidoc-template-maven-plugin] image::https://api.dependabot.com/badges/status?host=github&repo=whelk-io/flesch-kincaid[https://dependabot.com]
